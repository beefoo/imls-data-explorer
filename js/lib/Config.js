  ...
  filterBy: [
    {
      ...
      type: 'range',
      values: [
        { minValue: 0, maxValue: 19, label: 'City' },
        { minValue: 20, maxValue: 29, label: 'Suburb' },
        { minValue: 30, maxValue: 50, label: 'Town or rural' },
      ],
    },
    {
      label: 'State',
